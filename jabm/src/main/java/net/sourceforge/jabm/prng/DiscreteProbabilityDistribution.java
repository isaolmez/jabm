...
/**
 * A class representing a discrete probability distribution which can used to generate random events according to the
 * specified distribution. The output from a uniform PRNG is used to to select from the different possible events.
 *
 * @author Steve Phelps
