...
public interface DiscreteLearner extends Learner {
    ...
    /**
     * Request that the learner perform an action. Users of the learning algorithm should invoke this method on the
     * learner when they wish to find out which action the learner is currently recommending.
     *
