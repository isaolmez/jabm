...
/**
 * The SimulationController is responsible for running a batch of one or more independent Simulation runs. It is
 * responsible for establishing the event listening relationships between the different components of the simulation,
