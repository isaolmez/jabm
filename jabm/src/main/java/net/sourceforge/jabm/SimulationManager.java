...
/**
 * <p>
 * The main application class for JABM experiments when running in headless mode, e.g. on a cluster (to run using a GUI
 * see {@link net.sourceforge.jabm.DesktopSimulationManager}).
 * </p>
 *
 * <p>
 * Example usage:<br>
...
public class SimulationManager implements Runnable {
    ...
    /**
     * The (optional) file name of the variables file. The variables file specifies a parameter sweep experiment in
     * which the specified properties are systematically varied over the specified ranges of values.
     */
    protected String varFile;

    /**
     * The (optional) base directory in which subdirectories will be created for experiments involving paramater
     * sweeps.
     */
    protected String baseDirName;

    /**
     * If this option is set, then the simulation manager will create configuration files for experiments without
    ...
    public void runSingleExperiment(Properties properties) {
        SimulationExperiment experiment = new SimulationExperiment(properties);
        launch(experiment);
    }
