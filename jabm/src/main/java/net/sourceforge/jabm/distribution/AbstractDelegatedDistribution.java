...
public abstract class AbstractDelegatedDistribution
  extends AbstractContinousDistribution implements InitializingBean {
    ...
    /**
     * Initialise the delegate provided that the bean has already been configured.  This should be called by setters
     * after any moments are changed in case we are being configured by a PropertyOverrideConfigurator.
     */
