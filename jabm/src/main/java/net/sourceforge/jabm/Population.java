...
/**
 * A population of agents in a simulation.  The population can be resized dynamically.  Each time the population is
 * resized the agents in the population will be constructed via the specified <code>ObjectFactory</code>.
 *
 * @author Steve Phelps
 */
