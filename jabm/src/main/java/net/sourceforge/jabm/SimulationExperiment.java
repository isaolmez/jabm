...
/**
 * A simulation experiment represents a simulation and a corresponding treatment: that is, a set of parameter bindings
...
public class SimulationExperiment implements Runnable {
    ...
    /**
     * The properties specified here represent parameter bindings which override those specified in the original model
     * configuration.
     */
    ...
    /**
     * Initialise the model by constructing it from the bean factory and then applying the parameter bindings specified
     * by the properties attribute using Spring's properties post-processing feature.
     */
    ...
    /**
     * Save the parameter bindings of this experiment to a property file. The property file is called
     * 'experiment.properties' and is saved in the same directory as the report data.
     */
