...
public abstract class AbstractSimulation implements Simulation, Serializable {
    ...
    /**
     * Interval in milliseconds to wait in between steps if the simulation is to be slowed down. A value of zero
...
//	}
    ...
    /**
     * Schedule events of type AgentArrivalEvent for each agent in the simulation according to the AgentMixer in use by
