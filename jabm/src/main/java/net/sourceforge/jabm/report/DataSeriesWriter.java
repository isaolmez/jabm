...
/**
 * <p>
 * A data writer that stores data in a memory-resident data structure that can also be used as a data series model for a
 * JSci graph, or a table model for a swing JTable component.
 * </p>
 *
 * <p>
 * Each datum written to the DataWriter is one half a 2-dimensional coordinate. The first datum is typically a time
 * value.
 * </p>
 *
 * <p>
 ...
 *
 * <code>
 * DataSeriesWriter timeSeries = new DataSeriesWriter();<br> for( int t=0; t&lt;1000; t++ ) {<br>
 * timeSeries.newData(t);<br> timeSeries.newData(getValue(t));<br> }<br>
 * </code>
 *
 * @author Steve Phelps
