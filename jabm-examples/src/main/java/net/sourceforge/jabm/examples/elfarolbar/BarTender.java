...
/**
 * The BarTender agent keeps track of current and historical attendance at the bar, and writes the attendance time
 * series data to a CSV file at the end of each simulation.
 *
 * @author Steve Phelps
 */
public class BarTender extends AbstractReportVariables {
    ...
    /**
     * Get the attendance <code>lag</code> weeks ago relative to the current time.
     *
     * @param lag The number of periods to go back.
     * @return The total number of agents who attended the bar during the specified period.
     */
